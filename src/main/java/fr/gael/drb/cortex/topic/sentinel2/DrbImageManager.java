 ...
 * Copyright (C) 2013,2014,2015,2016,2017 European Space Agency (ESA)
 * Copyright (C) 2013,2014,2015,2016,2017 GAEL Systems
 * Copyright (C) 2013,2014,2015,2016,2017 Serco Spa
 *
...
public class DrbImageManager
{
   ...
   {
      String mgrs = null;
      if (name.matches("S2._.*")) // case of Old format
      {
         mgrs = name.substring(50, 55);
      }
      else if (name.startsWith("L2A_T")) // Compact L2A
      {
         mgrs = name.substring(5, 10);
      }
      else // Compact L1C
      {
